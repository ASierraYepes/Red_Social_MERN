...
import { Box, Divider, IconButton, Typography, useTheme, InputBase, Button, Snackbar, Fade } from "@mui/material";
  ...
  return (
    <WidgetWrapper m="2rem 0">
      ...
      {isComments && (
        <Fade  in={isComments}>
          <Box mt="0.5rem">
            <form onSubmit={(e) => { e.preventDefault(); patchComment(); }}>
              <FlexBetween gap="1.5rem">
                ...
                >
                  <Alert onClose={handleCloseSnackbarSuccess} severity="success" color="success" sx={{ width: '100%' }}>
                    Comentario creado!
                  </Alert>
                </Snackbar>
                <Snackbar
            ...
            {comments.length !== 0 ? (
              ...
              <>
                <Typography color={medium}>No hay comentarios...</Typography>
              </>
            )}
